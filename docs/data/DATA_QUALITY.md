...
- 데이터 사전: [DATA_DICTIONARY_2025.csv](tables/DATA_DICTIONARY_2025.csv)
...
- COD-16 지표 전달 결정: [EDA_INDICATOR_DECISIONS_2025.csv](tables/EDA_INDICATOR_DECISIONS_2025.csv)
- COD-16 실행 계약: [DOMAIN_SCORE_SPEC_2025.csv](tables/DOMAIN_SCORE_SPEC_2025.csv)
