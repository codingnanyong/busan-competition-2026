...
The subsequent [cluster-analysis review](CLUSTER_ANALYSIS_2025.md) did not find a stable
discrete typology, so later policy and visualization work continues to use these continuous
