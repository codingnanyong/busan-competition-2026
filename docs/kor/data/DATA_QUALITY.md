...
- 데이터 사전: [DATA_DICTIONARY_2025.csv](../../data/tables/DATA_DICTIONARY_2025.csv)
- 품질 리포트: [DATA_QUALITY_REPORT_2025.json](../../data/manifests/DATA_QUALITY_REPORT_2025.json)
- 공간·코드 결합 상세: [STANDARDIZATION_REPORT_2025.json](../../data/manifests/STANDARDIZATION_REPORT_2025.json)
- 사용 역할: [DATA_USAGE_REGISTER_2025.md](DATA_USAGE_REGISTER_2025.md)
- 탐색 분석: [EDA_2025.md](EDA_2025.md)
- COD-16 지표 전달 결정: [EDA_INDICATOR_DECISIONS_2025.csv](../../data/tables/EDA_INDICATOR_DECISIONS_2025.csv)
- COD-16 실행 계약: [DOMAIN_SCORE_SPEC_2025.csv](../../data/tables/DOMAIN_SCORE_SPEC_2025.csv)
- 영역 점수 보고서: [DOMAIN_SCORE_REPORT_2025.json](../../data/manifests/DOMAIN_SCORE_REPORT_2025.json)
- 종합점수 보고서: [COMPOSITE_INDEX_REPORT_2025.json](../../data/manifests/COMPOSITE_INDEX_REPORT_2025.json)
