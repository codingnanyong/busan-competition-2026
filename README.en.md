...
Evidence and row-level confidence for the eight policy categories, including estimated, proxy,
and interpolated inputs, are maintained in the [2025 category assessment](docs/en/methodology/CATEGORY_ASSESSMENT_2025.md).
