...
- 분석 근거, 의사결정, 데이터 사전과 릴리스 변경사항은 `docs/`에 함께 갱신합니다.

자세한 일정은 [프로젝트 계획](docs/PROJECT_PLAN.md), 실행 항목은 [Linear 이슈 맵](docs/ISSUES.md), 개발 방식은 [Git 워크플로](docs/GIT_WORKFLOW.md), 릴리스 방식은 [릴리스 정책](docs/RELEASE_POLICY.md)을 참고하세요.
